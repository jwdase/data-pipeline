...
# data/exp05/<scene>/data/<scene>_physics.usdc -- not flat in data/exp05/, and not the
...
EXP_DIR = Path(__file__).resolve().parents[2] / "data" / "exp05"
SCENES = {
...
if __name__ == "__main__":
    ...
    if not has_rigid_bodies(usd):
        ap.error(
            ...
            f"uv run eval/exp05/to_physics.py --scene {args.scene}"
        )
